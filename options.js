var Zepto = function() {
    ...
    return C.matches = function(t, e) {
        ...
        var r, i = t.parentNode,
            o = !i;
        return o && (i = N).appendChild(t), r = ~C.qsa(i, e).indexOf(t), o && N.removeChild(t), r
    }, i = function(t) {
        ...
        var o, a, c;
        return d.test(e) && (o = n(u.createElement(RegExp.$1))), o || (e.replace && (e = e.replace(m, "<$1></$2>")), r === t && (r = p.test(e) && RegExp.$1), r in w || (r = "*"), (c = w[r]).innerHTML = "" + e, o = n.each(s.call(c.childNodes), function() {
            c.removeChild(this)
        })), _(i) && (a = n(o), n.each(i, function(t, e) {
        ...
        if (!e) return C.Z();
        if ("string" == typeof e)
            if ("<" == (e = e.trim())[0] && p.test(e)) i = C.fragment(e, RegExp.$1, r), e = null;
            else {
                if (r !== t) return n(r).find(e);
                i = C.qsa(u, e)
            }
        else {
            if (A(e)) return n(u).ready(e);
            if (C.isZ(e)) return e;
            if (O(e)) o = e, i = c.call(o, function(t) {
                return null != t
            });
            else if (Z(e)) i = [e], e = null;
            else if (p.test(e)) i = C.fragment(e.trim(), RegExp.$1, r), e = null;
            else {
                if (r !== t) return n(r).find(e);
                i = C.qsa(u, e)
            }
        ...
        return "boolean" == typeof n && (r = n, n = i.shift()), i.forEach(function(i) {
            ! function n(r, i, o) {
                for (e in i) o && (_(i[e]) || O(i[e])) ? (_(i[e]) && !_(r[e]) && (r[e] = {}), O(i[e]) && !O(r[e]) && (r[e] = []), n(r[e], i[e], o)) : i[e] !== t && (r[e] = i[e])
            }(n, i, r)
        }), n
    }, C.qsa = function(t, e) {
        var n, r = "#" == e[0],
        ...
        for (; e && (e = e.parentNode);)
            if (e === t) return !0;
        return !1
    }, n.type = P, n.isFunction = A, n.isWindow = k, n.isArray = O, n.isPlainObject = _, n.isEmptyObject = function(t) {
        var e;
        for (e in t) return !1;
        return !0
        ...
        closest: function(t, e) {
            var r = this[0],
                i = !1;
            for ("object" == typeof t && (i = n(t)); r && !(i ? i.indexOf(r) >= 0 : C.matches(r, t));) r = r !== e && !L(r) && r.parentNode;
            return n(r)
        },
        parents: function(t) {
        ...
        show: function() {
            return this.each(function() {
                var t, e, n;
                "none" == this.style.display && (this.style.display = ""), "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = (t = this.nodeName, l[t] || (e = u.createElement(t), u.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), l[t] = n), l[t]))
            })
        },
        ...
        attr: function(n, r) {
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function(t) {
                if (1 === this.nodeType)
                    if (Z(n))
                        for (e in n) I(this, e, n[e]);
                    else I(this, n, H(this, r, t, this.getAttribute(n)))
        ...
        prop: function(t, e) {
            return t = $[t] || t, 1 in arguments ? this.each(function(n) {
        ...
        css: function(t, r) {
            if (arguments.length < 2) {
                var o, a = this[0];
                if (!a) return;
                if (o = getComputedStyle(a, ""), "string" == typeof t) return a.style[i(t)] || o.getPropertyValue(t);
                if (O(t)) {
                    var s = {};
            ...
            var c = "";
            if ("string" == P(t)) r || 0 === r ? c = M(t) + ":" + z(t, r) : this.each(function() {
                this.style.removeProperty(M(t))
            });
            else
                for (e in t) t[e] || 0 === t[e] ? c += M(e) + ":" + z(e, t[e]) + ";" : this.each(function() {
        ...
        n.fn[t] = function() {
            ...
            return o.length < 1 ? this : this.each(function(t, s) {
                i = r ? s : s.parentNode, s = 0 == e ? s.nextSibling : 1 == e ? s.firstChild : 2 == e ? s : null;
                var c = n.contains(u.documentElement, i);
                o.forEach(function(t) {
                    if (a) t = t.cloneNode(!0);
                    else if (!i) return n(t).remove();
                    i.insertBefore(t, s), c && function t(e, n) {
                        n(e);
    ...
    }), C.Z.prototype = n.fn, C.uniq = o, C.deserializeValue = B, n.zepto = C, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    function(t) {
        ...
        function g(n, r, i, o, s, c, u) {
            ...
            r.split(/\s/).forEach(function(r) {
                ...
                var a = p(r);
                a.fn = i, a.sel = s, a.e in l && (i = function(e) {
                ...
                }, a.i = g.length, g.push(a), "addEventListener" in n && n.addEventListener(m(a.e), a.proxy, d(a, u))
            })
        }
        ...
        t.fn.delegate = function(t, e, n) {
            ...
            return n && !o(n) ? (t.each(n, function(t, e) {
                h.on(t, a, s, e, u)
            }), h) : (o(a) || i(c) || !1 === c || (c = s, s = a, a = e), (i(s) || !1 === s) && (c = s, s = e), !1 === c && (c = x), h.each(function(e, i) {
                u && (l = function(t) {
                    return v(i, t.type, c), c.apply(this, arguments)
                }), a && (f = function(e) {
            ...
            return this.each(function(a, s) {
                (r = S(o(e) ? t.Event(e) : e))._args = n, r.target = s, t.each(h(s, e.type || e), function(t, e) {
    ...
    function(t) {
        ...
        function d(t, e, n, r) {
            var i = n.context;
            n.success.call(i, t, "success", e), r && r.resolveWith(i, [t, "success", e]), h(n, i, "ajaxSuccess", [e, n, t]), g("success", e, n)
        }

        function m(t, e, n, r, i) {
            var o = r.context;
            r.error.call(o, n, e, t), i && i.rejectWith(o, [n, e, t]), h(r, o, "ajaxError", [n, r, t || e]), g(e, n, r)
        }

        function g(e, n, r) {
            var i = r.context;
            r.complete.call(i, n, e), h(r, i, "ajaxComplete", [n, r]),
                function(e) {
        ...
        f.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            return n && n.promise(h), t(u).on("load error", function(r, i) {
                clearTimeout(a), t(u).off().remove(), "error" != r.type && o ? d(o[0], h, e, n) : m(null, i || "error", h, e, n), window[c] = l, o && t.isFunction(l) && l(o[0]), l = o = void 0
            }), !1 === p(h, e) ? (f("abort"), h) : (window[c] = function() {
                o = arguments
            }, u.src = e.url.replace(/\?(.+)=\?/, "?$1=" + c), i.head.appendChild(u), e.timeout > 0 && (a = setTimeout(function() {
                f("timeout")
            }, e.timeout)), h)
        }, t.ajaxSettings = {
            type: "GET",
            ...
            var o, g = t.extend({}, r || {}),
                x = t.Deferred && t.Deferred();
            for (e in t.ajaxSettings) void 0 === g[e] && (g[e] = t.ajaxSettings[e]);
            ! function(e) {
                e.global && 0 == t.active++ && h(e, null, "ajaxStart")
            }(g), g.crossDomain || ((o = i.createElement("a")).href = g.url, o.href = o.href, g.crossDomain = f.protocol + "//" + f.host != o.protocol + "//" + o.host), g.url || (g.url = window.location.toString()),
                function(e) {
            ...
            var b = g.dataType,
                w = /\?.+=\?/.test(g.url);
            if (w && (b = "jsonp"), !1 !== g.cache && (r && !0 === r.cache || "script" != b && "jsonp" != b) || (g.url = y(g.url, "_=" + Date.now())), "jsonp" == b) return w || (g.url = y(g.url, g.jsonp ? g.jsonp + "=?" : !1 === g.jsonp ? "" : "callback=?")), t.ajaxJSONP(g, x);
            var E, S = g.accepts[b],
                j = {},
                T = function(t, e) {
                    j[t.toLowerCase()] = [t, e]
                },
                C = /^([\w-]+:)\/\//.test(g.url) ? RegExp.$1 : window.location.protocol,
                N = g.xhr(),
                $ = N.setRequestHeader;
            if (x && x.promise(N), g.crossDomain || T("X-Requested-With", "XMLHttpRequest"), T("Accept", S || "*/*"), (S = g.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]), N.overrideMimeType && N.overrideMimeType(S)), (g.contentType || !1 !== g.contentType && g.data && "GET" != g.type.toUpperCase()) && T("Content-Type", g.contentType || "application/x-www-form-urlencoded"), g.headers)
                for (n in g.headers) T(n, g.headers[n]);
            if (N.setRequestHeader = T, N.onreadystatechange = function() {
                    if (4 == N.readyState) {
                        N.onreadystatechange = v, clearTimeout(E);
                        var e, n = !1;
                        if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                            b = b || ((r = g.mimeType || N.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r && (r == u ? "html" : r == c ? "json" : a.test(r) ? "script" : s.test(r) && "xml") || "text"), e = N.responseText;
                            try {
                                "script" == b ? (0, eval)(e) : "xml" == b ? e = N.responseXML : "json" == b && (e = l.test(e) ? null : t.parseJSON(e))
                            } catch (t) {
                                n = t
                            }
                            n ? m(n, "parsererror", N, g, x) : d(e, N, g, x)
                        } else m(N.statusText || null, N.status ? "error" : "abort", N, g, x)
                    }
                    var r
                }, !1 === p(N, g)) return N.abort(), m(null, "abort", N, g, x), N;
            if (g.xhrFields)
                for (n in g.xhrFields) N[n] = g.xhrFields[n];
            var O = !("async" in g) || g.async;
            for (n in N.open(g.type, g.url, O, g.username, g.password), j) $.apply(N, j[n]);
            return g.timeout > 0 && (E = setTimeout(function() {
                N.onreadystatechange = v, N.abort(), m(null, "timeout", N, g, x)
            }, g.timeout)), N.send(g.data ? g.data : null), N
        }, t.get = function() {
            ...
            var i, a = this,
                ...
                c = x(e, n, r),
                u = c.success;
            return s.length > 1 && (c.url = s[0], i = s[1]), c.success = function(e) {
                a.html(i ? t("<div>").html(e.replace(o, "")).find(i) : e), u && u.apply(a, arguments)
            }, t.ajax(c), this
        };
            ...
            return r.add = function(e, n) {
                ...
                function e(n, r, i, o) {
                    ...
                    t.each(r, function(r, u) {
                        a = t.type(u), o && (r = i ? o : o + "[" + (c || "object" == a || "array" == a ? r : "") + "]"), !o && s ? n.add(u.name, u.value) : "array" == a || !i && "object" == a ? e(n, u, i, r) : n.add(r, u)
                    })
    ...
    function(t) {
        ...
        localStorage["auto-homepage"] && "true" == localStorage["auto-homepage"] ? ($("#auto-open-homepage").attr("checked", "checked"), $("#choose-homepage").show()) : $("#choose-homepage").hide(), $(".homepage").each(function() {
            $(this).val() == localStorage.homepage ? ($(this).prop("checked", !0), $(this).click()) : $(this).prop("checked", !1)
        });
        var t = !!localStorage.homepage;
        console.log(t), $("#auto-open-homepage").click(function() {
            $(this).is(":checked") ? (localStorage["auto-homepage"] = "true", $("#choose-homepage").show(), localStorage.homepage || (localStorage.homepage = "http://360.hao245.com")) : (localStorage["auto-homepage"] = "false", $("#choose-homepage").hide())
        }), $(".homepage").click(function() {
            localStorage.homepage = $(this).val(), t = !0
